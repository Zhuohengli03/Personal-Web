 ...
 * Based on Navier-Stokes fluid dynamics simulation
 */
(function() {
  'use strict';
  ...
  const { gl, ext } = getWebGLContext(document.querySelector('.fluid-canvas'));
  ...
  let canvas = gl.canvas;
  // 使用 document 监听事件，这样 canvas 可以保持 pointer-events: none
